...
class Countdown extends StatefulWidget {
  ...
  /// time factor of microseconds available in builder
...
class _CountdownState extends State<Countdown> {
  ...
  void didUpdateWidget(Countdown oldWidget) {
    ...
    if (oldWidget.duration.inSeconds != widget.duration.inSeconds) _currentMicroSeconds = widget.duration.inMicroseconds;
  }
  ...
  Widget build(BuildContext context) {
    return widget.build(
      context,
      _currentMicroSeconds / widget.timeFactor, 
    );
  }
